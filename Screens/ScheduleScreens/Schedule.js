...
export default class Schedule extends React.Component {
    ...
    renderItem = (item) => <View style={[scheduleStyle.item, {height: item.height}]}><Text>{item.title}</Text></View>;

    renderEmptyDate = () => <View style={scheduleStyle.emptyDate}><Text>This is empty date!</Text></View>;
