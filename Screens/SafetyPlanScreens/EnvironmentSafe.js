...
const EnvironmentData = [
  ...
  },
  {
    ...
    info:
      '‘When I feel suicidal, I will leave my house and go to a place where there are people around, like a shopping centre, restaurant or library to distract myself’',
  },
  {
...
export default class EnvironmentSafe extends React.Component {
  ...
  infoAlert = (info) => {
    Alert.alert('For Example', info, [{ text: 'OK', onPress: () => console.log('OK pressed') }], { cancelable: false });
  };
