            ...
            <View style={contactListStyle.viewContainer}>
                ...
                <TouchableHighlight
                    ...
                    onPress={this.props.navigation.getParam('edit')
                        ? () => this.props.navigation.navigate('editHelper', {checkedContact: {contactId: Number(this.state.checkedContact[0]), contactName: this.state.contacts[this.state.checkedContact[0]]}})
                        : () => this.props.navigation.navigate('newHelper', {checkedContact: {contactId: Number(this.state.checkedContact[0]), contactName: this.state.contacts[this.state.checkedContact[0]]}})}
