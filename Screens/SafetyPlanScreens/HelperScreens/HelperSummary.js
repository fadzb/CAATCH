...
export default class HelperSummary extends React.Component {
    ...
    componentDidMount() {
        openSafetyPlanItem(UsageFunctionIds.mostViewed.helper, DbTableNames.helper, this.props.navigation.getParam('id'), DbPrimaryKeys.helper, this.props.navigation.getParam('name'));

        latestSafetyPlanItem(UsageFunctionIds.lastViewed.helper, this.props.navigation.getParam('id'), this.props.navigation.getParam('name'))
                ...
                <Container style={helperSummaryStyle.viewContainer}>
                    <Content>
                        <Card>
                            ...
                            <CardItem>
                                <Body>
                                <Text style={helperSummaryStyle.text}>
