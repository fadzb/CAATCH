    ...
    render() {
        return (
            <View style={TabStyles.stackContainer}>
                ...
                <SafetyPlanSelector iconName={Icons.distractions + "-outline"} iconSize={iconSize} name={SafetyPlanDbTables.distraction.title} press={this.handleItemPress} screen="selectDistraction"/>
                <SafetyPlanSelector iconName={Icons.lifeWorthLiving + "-outline"} iconSize={iconSize} name={SafetyPlanDbTables.reason.title} press={this.handleItemPress} screen="reason"/>
                ...
                <SafetyPlanSelector iconName={Icons.environmentSafe + "-outline"} iconSize={iconSize} name={SafetyPlanDbTables.environment.title} press={this.handleItemPress} screen="environment"/>
            </View>
        );
    }
}
