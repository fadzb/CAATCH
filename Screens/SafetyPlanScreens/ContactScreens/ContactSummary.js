...
import { View, StyleSheet, Dimensions, Modal, TouchableHighlight, TouchableOpacity, Linking, FlatList, Text, Alert } from 'react-native';
...
export default class ContactSummary extends React.Component {
    ...
    componentDidMount() {
        this.getName(() => {
            openSafetyPlanItem(UsageFunctionIds.mostViewed.contact, DbTableNames.contact, this.props.navigation.getParam('id'), DbPrimaryKeys.contact, this.state.name);
                ...
                <View style={contactSummaryStyle.thumbnailContainer}>
                    ...
                    <View style={contactSummaryStyle.deleteEditButtons}>
                        <PressableIcon
                            ...
                            size={35}
                            onPressFunction={() => this.editContact(this.props.navigation.getParam('id'),
                ...
                <View style={contactSummaryStyle.contactTextRow}>
                    ...
                    <View style={contactSummaryStyle.contactButtonsView}>
                        ...
                        <PressableIcon
                            ...
                            size={iconSize}
                            color={'#4FCE5D'}
                            onPressFunction={() => Linking.openURL('whatsapp://send?text=&phone=' + phone).catch(err => console.log(err))}
                        />
                    </View>
                </View>
