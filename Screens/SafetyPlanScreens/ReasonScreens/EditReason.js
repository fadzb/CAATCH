...
export default class EditReason extends React.Component {
  ...
  constructor(props) {
    ...
    this.state = {
      value: {
        reasonName: this.props.navigation.getParam('name'),
        reasonDesc: this.props.navigation.getParam('desc'),
        reasonUrl: this.props.navigation.getParam('url'),
      },
      selectedMediaUri: '',
      selectedMediaName: '',
      selectedMediaType: '',
