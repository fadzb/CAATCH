...
export default class SafetyPlanSummary extends React.Component {
  ...
  getArchive = () => {
    ...
    const columns = `d.sessionId, s.diaryDate, ${type === 'cope' ? 'd.copeId' : 'd.signId'}, s.dateEntered, ${
      type === 'cope' ? 'di.copeName' : 'di.signName'
    }`;
