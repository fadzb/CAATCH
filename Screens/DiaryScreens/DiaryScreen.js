...
import { StyleSheet, Text, View, Button, TextInput, Modal, TouchableHighlight, TouchableOpacity, Platform } from 'react-native';
        ...
        return (
            <View style={TabStyles.stackContainer}>
                ...
                <View style={{flex: 1, alignSelf: 'stretch'}}>
                    <DiaryGrid dbtEnabled={this.props.settings.dbt} navigation={this.props.navigation} date={Moment(this.props.diaryDate).format('LL')}/>
                </View>
