...
export const CheckBox = (locals) => {
    ...
    return (
        <View style={formGroupStyle}>
            <View style={{paddingHorizontal: 7, borderRadius: 4, marginBottom: 4, borderColor: '#cccccc', borderWidth: 1, flexDirection: 'row', alignItems: 'center', paddingVertical: 5, justifyContent: 'space-between'}}>
                {label}
                <Switch
