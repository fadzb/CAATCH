...
const REACTIONS = [
    ...
    { label: "Strong", src: require('../Media/Images/ambitious.png'), bigSrc: require('../Media/Images/ambitious_big.png') },
    { label: "Happy", src: require('../Media/Images/smile.png'), bigSrc: require('../Media/Images/smile_big.png') },
    { label: "Surprised", src: require('../Media/Images/surprised.png'), bigSrc: require('../Media/Images/surprised_big.png') },
];
